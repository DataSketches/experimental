 ...
 *
 * <p>The Count-Min algorithm can process deletion of items as well as insertions, since it is a linear
 ...
 *
 * <p>This implementation uses powers of 2 hash-table sizes and a single-dimensional array for
...
public class CountMinFast {
   ...
   *        where n is sum of item frequencies
   */
  public CountMinFast(final double eps, final double delta) {
    if (eps <= 0 || delta <= 0) {
   ...
   *         changed.
   */
  public CountMinFast merge(final CountMinFast other) {
