 ...
 *
 * <p>DHWR = Double Hashing With Rebuilds HashMap. Knuth OADH
 *
 * @author Justin8712
 */
public class FrequentItemsDHWR {
   ...
   */
  public FrequentItemsDHWR(final double errorParameter) {
    if (errorParameter <= 0) {
   ...
   *         changed.
   */
  public FrequentItemsDHWR merge(final FrequentItemsDHWR other) {
