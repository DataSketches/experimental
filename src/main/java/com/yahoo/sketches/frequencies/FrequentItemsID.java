 ...
 *
 * <p>Uses HashMapWithImplicitDeletes.
 *
 * @author Justin8712
 */
public class FrequentItemsID {
   ...
   */
  public FrequentItemsID(final double errorParameter) {
    if (errorParameter <= 0) {
  ...
  /**
   * @param other Another FrequentItemsID sketch. Potentially of different size.
   ...
   *         changed.
   */
  public FrequentItemsID merge(final FrequentItemsID other) {
