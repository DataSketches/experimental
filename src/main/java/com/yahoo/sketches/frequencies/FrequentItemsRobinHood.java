 ...
 * @author Justin8712
 */
public class FrequentItemsRobinHood extends FrequencyEstimator{
  ...
  private void purge()
  {
   ...
   /**
    * @param other
    * Another FrequentItemsRobinHood sketch. Potentially of different size. 
   ...
   public FrequencyEstimator merge(FrequencyEstimator other) {
     if (!(other instanceof FrequentItemsRobinHood)) throw new IllegalArgumentException("SpaceSaving can only merge with other SpaceSaving");
       FrequentItemsRobinHood otherCasted = (FrequentItemsRobinHood) other;
