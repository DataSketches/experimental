 ...
 *
 * <p>Uses HashMapRobinHood.
 *
 * @author Justin8712
 */
public class FrequentItemsRobinHood {

  private HashMapRobinHood counters;
   ...
   */
  public FrequentItemsRobinHood(final double errorParameter) {
    if (errorParameter <= 0) {
   ...
   *         changed.
   */
  public FrequentItemsRobinHood merge(final FrequentItemsRobinHood other) {
